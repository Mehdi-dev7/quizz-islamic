						...
						<div>
							...
							{formData.password && (
								<div className="mt-2 space-y-1 text-sm">
									<div
										className={`flex items-center gap-2 ${passwordChecks.minLength ? "text-green-600" : "text-gray-400"}`}
									>
										{passwordChecks.minLength ? "✓" : "○"}{" "}
										{t("passwordRules.minLength")}
									</div>
									<div
										className={`flex items-center gap-2 ${passwordChecks.hasUppercase ? "text-green-600" : "text-gray-400"}`}
									>
										{passwordChecks.hasUppercase ? "✓" : "○"}{" "}
										{t("passwordRules.uppercase")}
									</div>
									<div
										className={`flex items-center gap-2 ${passwordChecks.hasNumber ? "text-green-600" : "text-gray-400"}`}
									>
										{passwordChecks.hasNumber ? "✓" : "○"}{" "}
										{t("passwordRules.number")}
									</div>
									<div
										className={`flex items-center gap-2 ${passwordChecks.hasSpecial ? "text-green-600" : "text-gray-400"}`}
									>
